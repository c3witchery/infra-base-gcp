...
//        "k8s-subnet",
//        SubnetworkArgs.builder().ipCidrRange("10.2.0.0/16").network(network.selfLink()).region("us-central1").build(),
...
//    val cluster = Cluster(
//        "corda-k8s-cluster",
//        ClusterArgs.builder().initialNodeCount(1).nodeConfig(
//            ClusterNodeConfigArgs.builder().machineType("n1-standard-1").oauthScopes(
//                "https://www.googleapis.com/auth/compute",
//                "https://www.googleapis.com/auth/devstorage.read_only",
//                "https://www.googleapis.com/auth/logging.write",
//                "https://www.googleapis.com/auth/monitoring"
//            ).build()
//        ).network(network.selfLink()).subnetwork(subnet.selfLink()).build(),
//        CustomResourceOptions.builder()
...
//    )
//
//    var masterAuthClusterCaCertificate = cluster.masterAuth().applyValue { a ->
...
//        masterAuthClusterCaCertificate.applyValue { caCert ->
//            MessageFormat.format(yamlTemplate, clusterName, endpoint, caCert)
//        }.toString()
//    }
